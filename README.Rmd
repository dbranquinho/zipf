...
Temos 72% de precisão para classes de separação difíceis, mas outros documentos com boa separação obtivemos 92%, esse é um bom resultado para taxas de precisão.
